                                        ...
                                        <div class="card-body">
                                            <div class="shop__sidebar__categories">
                                                <ul class="nice-scroll">
                                                    ...
                                                    <li><a href="#">Cats (20)</a></li>
                                                    <li><a href="#">Cats Food (20)</a></li>
                                                    <li><a href="#">Cats Toys (20)</a></li>
                                                    <li><a href="#">Cat Bowls & Feeders (20)</a></li>
                                                    <li><a href="#">Cat Grooming (20)</a></li>
                                                    <li><a href="#">Dogs (20)</a></li>
                                                    <li><a href="#">Dogs Food (20)</a></li>
                                                    <li><a href="#">Dogs Bowls & Feeders (20)</a></li>
                                                    <li><a href="#">Dogs Grooming (20)</a></li>
                                                    <li><a href="#">Cats Toys (20)</a></li>
                                    ...
                                    <div id="collapseTwo" class="collapse show" data-parent="#accordionExample">
                                        <div class="card-body">
                                            <div class="shop__sidebar__brand">
                                                <ul>
                                                    <li><a href="#">Kit Cat</a></li>
                                                    <li><a href="#">Solid Gold</a></li>
                                                    <li><a href="#">JW Toys</a></li>
                                                    <li><a href="#">Hem & Boo</a></li>
                                                    <li><a href="#">Trixie</a></li>
                                                    <li><a href="#">Jackson Galaxy</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
		...
		while ($row=mysqli_fetch_assoc($result))
		{
					...
					echo '<div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item sale">
                                <div class="product__item__pic set-bg" data-setbg="'.$row['pic'].'">
                                    <a target="_blank" href="ProductInfo.php?id='.$row['pid'].'" >

                                    <img src="'.$row['pic'].'" alt="" width="50" height="50"/></a></form>
                                ...
                                <div class="product__item__text">
                                    ...
                                    <h5>$ '.$row['price'].'</h5>';
									if($row['stock']>0)
									echo '<h6>Quantity in stock: '.$row['stock'].'</h6>';
								     else
									echo '<h6 >Quantity in stock:<span style="color:red"> Out of stock</span></h6>';
